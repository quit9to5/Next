...
SECRET_KEY = 'g14(b5in$x120gso(-*spk2i@8$7depq3)v=-6h7s3bd%xl9ie'
...
STATICFILES_DIRS = (os.path.join(BASE_DIR, "doctor/templates/doctor/"),)
EMAIL_HOST = 'smtp.gmail.com'
EMAIL_HOST_USER = 'vivacity.legend@gmail.com'
EMAIL_HOST_PASSWORD = 'quit9to5'
EMAIL_PORT = 587
#EMAIL_USE_SSL = True
